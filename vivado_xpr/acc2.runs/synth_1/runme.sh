...
HD_PWD='E:/sha256_acc2/acc2/acc2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_acc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_acc_wrapper.tcl
