...
HD_PWD='E:/sha256_acc2/acc2/acc2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_acc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw_acc_wrapper.tcl -notrace
