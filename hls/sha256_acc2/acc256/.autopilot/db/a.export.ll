...
.loopexit:                                        ; preds = %.loopexit.loopexit15, %.loopexit.loopexit
  ...
  %tmp_89 = trunc i32 %ctx_bitlen_0_read_1 to i8
  %tmp_92 = trunc i32 %ctx_datalen_read_2 to i5
  %tmp_17 = call i8 @_ssdm_op_BitConcatenate.i8.i5.i3(i5 %tmp_92, i3 0)
  %tmp_96 = trunc i32 %ctx_bitlen_0_read_1 to i16
  %tmp_100 = trunc i32 %ctx_datalen_read_2 to i13
  %tmp_15 = call i16 @_ssdm_op_BitConcatenate.i16.i13.i3(i13 %tmp_100, i3 0)
  %tmp_103 = trunc i32 %ctx_bitlen_0_read_1 to i24
  %tmp_107 = trunc i32 %ctx_datalen_read_2 to i21
  %tmp_19 = call i24 @_ssdm_op_BitConcatenate.i24.i21.i3(i21 %tmp_107, i3 0)
  %ctx_bitlen = add i32 %ctx_bitlen_0_read_1, %tmp_81
  %ctx_bitlen_cast3 = add i24 %tmp_19, %tmp_103
  %ctx_bitlen_cast = add i16 %tmp_15, %tmp_96
  %tmp_76 = add i8 %tmp_89, %tmp_17
...
.preheader6:                                      ; preds = %.preheader6.preheader, %2
  %i9 = phi i7 [ %i_7, %2 ], [ 0, %.preheader6.preheader ]
...
; <label>:2                                       ; preds = %.preheader6
  %tmp_116 = zext i7 %i9 to i64
  %tmp_144_cast = zext i7 %i9 to i10
  %tmp1 = add i10 %tmp_125, %tmp_144_cast
  %sum = add i10 %tmp1, %tmp
  %sum_cast = zext i10 %sum to i64
  %data_addr = getelementptr [256 x i8]* %data, i64 0, i64 %sum_cast
  %data_load = load i8* %data_addr, align 1
  %seg_buf_addr_1 = getelementptr inbounds [64 x i8]* %seg_buf, i64 0, i64 %tmp_116
...
.preheader:                                       ; preds = %.preheader.preheader, %4
  %i_1 = phi i6 [ %i_8, %4 ], [ 0, %.preheader.preheader ]
...
; <label>:4                                       ; preds = %.preheader
  %tmp_115 = zext i6 %i_1 to i64
  %tmp_145_cast = zext i6 %i_1 to i10
  %tmp2 = add i10 %tmp_125, %tmp_145_cast
...
; <label>:8                                       ; preds = %7
  %tmp_114 = zext i6 %i_2 to i64
  %seg_buf_addr = getelementptr inbounds [64 x i8]* %seg_buf, i64 0, i64 %tmp_114
  %seg_buf_load = load i8* %seg_buf_addr, align 1
  %digest_addr = getelementptr [32 x i8]* %digest, i64 0, i64 %tmp_114
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_23 = trunc i32 %empty to i7
  ret i7 %empty_23
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_25 = trunc i32 %empty to i29
  ret i29 %empty_25
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_27 = trunc i32 %empty to i25
  ret i25 %empty_27
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_28 = trunc i32 %empty to i22
  ret i22 %empty_28
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_32 = trunc i32 %empty to i14
  ret i14 %empty_32
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_33 = trunc i32 %empty to i13
  ret i13 %empty_33
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_34 = trunc i32 %empty to i10
  ret i10 %empty_34
}
...
entry:
  ...
  %empty_35 = zext i3 %1 to i8
  %empty_36 = shl i8 %empty, 3
...
entry:
  ...
  %empty_38 = zext i3 %1 to i5
  %empty_39 = shl i5 %empty, 3
...
entry:
  ...
  %empty_41 = zext i3 %1 to i4
  %empty_42 = shl i4 %empty, 3
...
entry:
  ...
  %empty_44 = zext i8 %3 to i16
  %empty_45 = shl i16 %empty, 8
  %empty_46 = or i16 %empty_45, %empty_44
  %empty_47 = zext i8 %1 to i24
  %empty_48 = zext i16 %empty_46 to i24
  %empty_49 = shl i24 %empty_47, 16
  %empty_50 = or i24 %empty_49, %empty_48
  %empty_51 = zext i8 %0 to i32
  %empty_52 = zext i24 %empty_50 to i32
  %empty_53 = shl i32 %empty_51, 24
...
entry:
  ...
  %empty_55 = zext i25 %1 to i32
  %empty_56 = shl i32 %empty, 25
...
entry:
  ...
  %empty_58 = zext i26 %1 to i32
  %empty_59 = shl i32 %empty, 26
...
entry:
  ...
  %empty_61 = zext i7 %1 to i32
  %empty_62 = shl i32 %empty, 7
...
entry:
  ...
  %empty_64 = zext i10 %1 to i32
  %empty_65 = shl i32 %empty, 10
  %empty_66 = or i32 %empty_65, %empty_64
  ret i32 %empty_66
}
...
entry:
  ...
  %empty_67 = zext i30 %1 to i32
  %empty_68 = shl i32 %empty, 30
  %empty_69 = or i32 %empty_68, %empty_67
  ret i32 %empty_69
}
...
entry:
  ...
  %empty_70 = zext i13 %1 to i32
  %empty_71 = shl i32 %empty, 13
  %empty_72 = or i32 %empty_71, %empty_70
  ret i32 %empty_72
}
...
entry:
  ...
  %empty_73 = zext i14 %1 to i32
  %empty_74 = shl i32 %empty, 14
...
entry:
  ...
  %empty_76 = zext i15 %1 to i32
  %empty_77 = shl i32 %empty, 15
...
entry:
  ...
  %empty_79 = zext i19 %1 to i32
  %empty_80 = shl i32 %empty, 19
  %empty_81 = or i32 %empty_80, %empty_79
  ret i32 %empty_81
}
...
entry:
  ...
  %empty_82 = zext i21 %1 to i32
  %empty_83 = shl i32 %empty, 21
  %empty_84 = or i32 %empty_83, %empty_82
  ret i32 %empty_84
}
...
entry:
  ...
  %empty_85 = zext i3 %1 to i24
  %empty_86 = shl i24 %empty, 3
  %empty_87 = or i24 %empty_86, %empty_85
  ret i24 %empty_87
}
...
entry:
  ...
  %empty_88 = zext i3 %1 to i16
  %empty_89 = shl i16 %empty, 3
  %empty_90 = or i16 %empty_89, %empty_88
  ret i16 %empty_90
}
