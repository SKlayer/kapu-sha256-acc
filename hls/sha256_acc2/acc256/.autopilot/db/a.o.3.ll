; ModuleID = 'E:/acc_2562/sha256_acc2/acc256/.autopilot/db/a.o.3.bc'
...
define internal fastcc { i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32 } @sha256_update([64 x i8]* nocapture %ctx_data, i32 %ctx_datalen_read, i32 %p_read1, i32 %p_read2, i32 %p_read3, i32 %p_read4, i32 %p_read5, i32 %p_read6, i32 %p_read7, i32 %p_read8, i32 %p_read9, i32 %p_read10, [64 x i8]* nocapture %data, i32 %len) {
  ...
  call void @llvm.dbg.value(metadata !{i32 %len_read}, i64 0, metadata !59), !dbg !60 ; [debug line = 86:72] [debug variable = len]
  ...
  call void @llvm.dbg.value(metadata !{[64 x i8]* %data}, i64 0, metadata !66), !dbg !67 ; [debug line = 86:51] [debug variable = data]
  call void @llvm.dbg.value(metadata !{i32 %len}, i64 0, metadata !59), !dbg !60 ; [debug line = 86:72] [debug variable = len]
...
define internal fastcc { i32, i32, i32, i32, i32, i32, i32, i32 } @sha256_transform(i32 %ctx_state_0_read, i32 %ctx_state_1_read, i32 %ctx_state_2_read, i32 %ctx_state_3_read, i32 %ctx_state_4_read, i32 %ctx_state_5_read, i32 %ctx_state_6_read, i32 %ctx_state_7_read, [64 x i8]* nocapture %data) readonly {
  ...
  call void @llvm.dbg.value(metadata !{[64 x i8]* %data}, i64 0, metadata !84), !dbg !88 ; [debug line = 30:54] [debug variable = data]
  call void @llvm.dbg.declare(metadata !{[64 x i32]* %m}, metadata !89), !dbg !92 ; [debug line = 32:43] [debug variable = m]
...
define internal fastcc void @sha256_final([64 x i8]* nocapture %ctx_data, i32 %ctx_datalen_read, i32 %ctx_bitlen_0_read, i32 %p_read3, i32 %p_read1, i32 %p_read2, i32 %p_read4, i32 %p_read5, i32 %p_read6, i32 %p_read7, i32 %p_read8, i32 %p_read9, [64 x i8]* nocapture %hash) {
  ...
  call void @llvm.dbg.value(metadata !{[64 x i8]* %hash}, i64 0, metadata !140), !dbg !141 ; [debug line = 101:50] [debug variable = hash]
...
.loopexit:                                        ; preds = %.loopexit.loopexit15, %.loopexit.loopexit
  ...
  %tmp_89 = trunc i32 %ctx_bitlen_0_read_1 to i8  ; [#uses=1 type=i8]
  %tmp_92 = trunc i32 %ctx_datalen_read_2 to i5   ; [#uses=1 type=i5]
  %tmp_17 = call i8 @_ssdm_op_BitConcatenate.i8.i5.i3(i5 %tmp_92, i3 0) ; [#uses=1 type=i8]
  %tmp_96 = trunc i32 %ctx_bitlen_0_read_1 to i16 ; [#uses=1 type=i16]
  %tmp_100 = trunc i32 %ctx_datalen_read_2 to i13 ; [#uses=1 type=i13]
  %tmp_15 = call i16 @_ssdm_op_BitConcatenate.i16.i13.i3(i13 %tmp_100, i3 0) ; [#uses=1 type=i16]
  %tmp_103 = trunc i32 %ctx_bitlen_0_read_1 to i24 ; [#uses=1 type=i24]
  %tmp_107 = trunc i32 %ctx_datalen_read_2 to i21 ; [#uses=1 type=i21]
  %tmp_19 = call i24 @_ssdm_op_BitConcatenate.i24.i21.i3(i21 %tmp_107, i3 0) ; [#uses=1 type=i24]
  %ctx_bitlen = add i32 %ctx_bitlen_0_read_1, %tmp_81, !dbg !162 ; [#uses=1 type=i32] [debug line = 125:76]
  %ctx_bitlen_cast3 = add i24 %tmp_19, %tmp_103, !dbg !163 ; [#uses=1 type=i24] [debug line = 126:4]
  %ctx_bitlen_cast = add i16 %tmp_15, %tmp_96, !dbg !163 ; [#uses=1 type=i16] [debug line = 126:4]
  %tmp_76 = add i8 %tmp_89, %tmp_17, !dbg !163    ; [#uses=1 type=i8] [debug line = 126:4]
...
.preheader6:                                      ; preds = %2, %.preheader6.preheader
  %i9 = phi i7 [ %i_7, %2 ], [ 0, %.preheader6.preheader ] ; [#uses=4 type=i7]
  ...
  %i_7 = add i7 %i9, 1, !dbg !270                 ; [#uses=1 type=i7] [debug line = 36:20]
  br i1 %exitcond5, label %3, label %2, !dbg !265 ; [debug line = 36:9]

; <label>:2                                       ; preds = %.preheader6
  %tmp_116 = zext i7 %i9 to i64, !dbg !271        ; [#uses=1 type=i64] [debug line = 37:5]
  %tmp_144_cast = zext i7 %i9 to i10              ; [#uses=1 type=i10]
  %tmp1 = add i10 %tmp_125, %tmp_144_cast         ; [#uses=1 type=i10]
  ...
  %seg_buf_addr_1 = getelementptr inbounds [64 x i8]* %seg_buf, i64 0, i64 %tmp_116, !dbg !271 ; [#uses=1 type=i8*] [debug line = 37:5]
  store i8 %data_load, i8* %seg_buf_addr_1, align 1, !dbg !271 ; [debug line = 37:5]
  call void @llvm.dbg.value(metadata !{i7 %i_7}, i64 0, metadata !272), !dbg !270 ; [debug line = 36:20] [debug variable = i]
...
.preheader:                                       ; preds = %4, %.preheader.preheader
  %i_1 = phi i6 [ %i_8, %4 ], [ 0, %.preheader.preheader ] ; [#uses=4 type=i6]
  ...
  %i_8 = add i6 %i_1, 1, !dbg !277                ; [#uses=1 type=i6] [debug line = 44:19]
  br i1 %exitcond4, label %5, label %4, !dbg !267 ; [debug line = 44:9]

; <label>:4                                       ; preds = %.preheader
  %tmp_115 = zext i6 %i_1 to i64, !dbg !278       ; [#uses=1 type=i64] [debug line = 45:5]
  %tmp_145_cast = zext i6 %i_1 to i10             ; [#uses=1 type=i10]
  %tmp2 = add i10 %tmp_125, %tmp_145_cast         ; [#uses=1 type=i10]
  ...
  %seg_buf_addr_2 = getelementptr inbounds [64 x i8]* %seg_buf, i64 0, i64 %tmp_115, !dbg !278 ; [#uses=1 type=i8*] [debug line = 45:5]
  store i8 %data_load_4, i8* %seg_buf_addr_2, align 1, !dbg !278 ; [debug line = 45:5]
  call void @llvm.dbg.value(metadata !{i6 %i_8}, i64 0, metadata !272), !dbg !277 ; [debug line = 44:19] [debug variable = i]
...
; <label>:7                                       ; preds = %8, %6
  %i_2 = phi i6 [ 0, %6 ], [ %i, %8 ]             ; [#uses=3 type=i6]
  %exitcond = icmp eq i6 %i_2, -32, !dbg !281     ; [#uses=1 type=i1] [debug line = 54:7]
  %empty_19 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 32, i64 32, i64 32) nounwind ; [#uses=0 type=i32]
  %i = add i6 %i_2, 1, !dbg !283                  ; [#uses=1 type=i6] [debug line = 54:18]
  br i1 %exitcond, label %9, label %8, !dbg !281  ; [debug line = 54:7]

; <label>:8                                       ; preds = %7
  %tmp_114 = zext i6 %i_2 to i64, !dbg !284       ; [#uses=2 type=i64] [debug line = 56:3]
  %seg_buf_addr = getelementptr inbounds [64 x i8]* %seg_buf, i64 0, i64 %tmp_114, !dbg !284 ; [#uses=1 type=i8*] [debug line = 56:3]
  %seg_buf_load = load i8* %seg_buf_addr, align 1, !dbg !284 ; [#uses=1 type=i8] [debug line = 56:3]
  %digest_addr = getelementptr [32 x i8]* %digest, i64 0, i64 %tmp_114, !dbg !284 ; [#uses=1 type=i8*] [debug line = 56:3]
  store i8 %seg_buf_load, i8* %digest_addr, align 1, !dbg !284 ; [debug line = 56:3]
  call void @llvm.dbg.value(metadata !{i6 %i}, i64 0, metadata !272), !dbg !283 ; [debug line = 54:18] [debug variable = i]
  br label %7, !dbg !283                          ; [debug line = 54:18]

; <label>:9                                       ; preds = %7
  ret void, !dbg !286                             ; [debug line = 58:1]
}
...
entry:
  ...
  %empty_20 = trunc i32 %empty to i8              ; [#uses=1 type=i8]
  ret i8 %empty_20
}
...
entry:
  ...
  %empty_21 = trunc i24 %empty to i8              ; [#uses=1 type=i8]
  ret i8 %empty_21
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_23 = trunc i32 %empty to i7              ; [#uses=1 type=i7]
  ret i7 %empty_23
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_25 = trunc i32 %empty to i29             ; [#uses=1 type=i29]
  ret i29 %empty_25
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_26 = trunc i32 %empty to i26             ; [#uses=1 type=i26]
  ret i26 %empty_26
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_27 = trunc i32 %empty to i25             ; [#uses=1 type=i25]
  ret i25 %empty_27
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_28 = trunc i32 %empty to i22             ; [#uses=1 type=i22]
  ret i22 %empty_28
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_29 = trunc i32 %empty to i21             ; [#uses=1 type=i21]
  ret i21 %empty_29
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_31 = trunc i32 %empty to i15             ; [#uses=1 type=i15]
  ret i15 %empty_31
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_32 = trunc i32 %empty to i14             ; [#uses=1 type=i14]
  ret i14 %empty_32
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_33 = trunc i32 %empty to i13             ; [#uses=1 type=i13]
  ret i13 %empty_33
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_34 = trunc i32 %empty to i10             ; [#uses=1 type=i10]
  ret i10 %empty_34
}
...
entry:
  ...
  %empty_35 = zext i3 %1 to i8                    ; [#uses=1 type=i8]
  %empty_36 = shl i8 %empty, 3                    ; [#uses=1 type=i8]
...
entry:
  ...
  %empty_38 = zext i3 %1 to i5                    ; [#uses=1 type=i5]
  %empty_39 = shl i5 %empty, 3                    ; [#uses=1 type=i5]
...
entry:
  ...
  %empty_41 = zext i3 %1 to i4                    ; [#uses=1 type=i4]
  %empty_42 = shl i4 %empty, 3                    ; [#uses=1 type=i4]
...
entry:
  ...
  %empty_44 = zext i8 %3 to i16                   ; [#uses=1 type=i16]
  %empty_45 = shl i16 %empty, 8                   ; [#uses=1 type=i16]
  %empty_46 = or i16 %empty_45, %empty_44         ; [#uses=1 type=i16]
  %empty_47 = zext i8 %1 to i24                   ; [#uses=1 type=i24]
  %empty_48 = zext i16 %empty_46 to i24           ; [#uses=1 type=i24]
  %empty_49 = shl i24 %empty_47, 16               ; [#uses=1 type=i24]
  %empty_50 = or i24 %empty_49, %empty_48         ; [#uses=1 type=i24]
  %empty_51 = zext i8 %0 to i32                   ; [#uses=1 type=i32]
  %empty_52 = zext i24 %empty_50 to i32           ; [#uses=1 type=i32]
  %empty_53 = shl i32 %empty_51, 24               ; [#uses=1 type=i32]
  %empty_54 = or i32 %empty_53, %empty_52         ; [#uses=1 type=i32]
  ret i32 %empty_54
}
...
entry:
  ...
  %empty_55 = zext i25 %1 to i32                  ; [#uses=1 type=i32]
  %empty_56 = shl i32 %empty, 25                  ; [#uses=1 type=i32]
...
entry:
  ...
  %empty_58 = zext i26 %1 to i32                  ; [#uses=1 type=i32]
  %empty_59 = shl i32 %empty, 26                  ; [#uses=1 type=i32]
...
entry:
  ...
  %empty_61 = zext i7 %1 to i32                   ; [#uses=1 type=i32]
  %empty_62 = shl i32 %empty, 7                   ; [#uses=1 type=i32]
...
entry:
  ...
  %empty_64 = zext i10 %1 to i32                  ; [#uses=1 type=i32]
  %empty_65 = shl i32 %empty, 10                  ; [#uses=1 type=i32]
  %empty_66 = or i32 %empty_65, %empty_64         ; [#uses=1 type=i32]
  ret i32 %empty_66
}
...
entry:
  ...
  %empty_67 = zext i30 %1 to i32                  ; [#uses=1 type=i32]
  %empty_68 = shl i32 %empty, 30                  ; [#uses=1 type=i32]
  %empty_69 = or i32 %empty_68, %empty_67         ; [#uses=1 type=i32]
  ret i32 %empty_69
}
...
entry:
  ...
  %empty_70 = zext i13 %1 to i32                  ; [#uses=1 type=i32]
  %empty_71 = shl i32 %empty, 13                  ; [#uses=1 type=i32]
  %empty_72 = or i32 %empty_71, %empty_70         ; [#uses=1 type=i32]
  ret i32 %empty_72
}
...
entry:
  ...
  %empty_73 = zext i14 %1 to i32                  ; [#uses=1 type=i32]
  %empty_74 = shl i32 %empty, 14                  ; [#uses=1 type=i32]
  %empty_75 = or i32 %empty_74, %empty_73         ; [#uses=1 type=i32]
  ret i32 %empty_75
}
...
entry:
  ...
  %empty_76 = zext i15 %1 to i32                  ; [#uses=1 type=i32]
  %empty_77 = shl i32 %empty, 15                  ; [#uses=1 type=i32]
  %empty_78 = or i32 %empty_77, %empty_76         ; [#uses=1 type=i32]
  ret i32 %empty_78
}
...
entry:
  ...
  %empty_79 = zext i19 %1 to i32                  ; [#uses=1 type=i32]
  %empty_80 = shl i32 %empty, 19                  ; [#uses=1 type=i32]
  %empty_81 = or i32 %empty_80, %empty_79         ; [#uses=1 type=i32]
  ret i32 %empty_81
}
...
entry:
  ...
  %empty_82 = zext i21 %1 to i32                  ; [#uses=1 type=i32]
  %empty_83 = shl i32 %empty, 21                  ; [#uses=1 type=i32]
  %empty_84 = or i32 %empty_83, %empty_82         ; [#uses=1 type=i32]
  ret i32 %empty_84
}
...
entry:
  ...
  %empty_85 = zext i3 %1 to i24                   ; [#uses=1 type=i24]
  %empty_86 = shl i24 %empty, 3                   ; [#uses=1 type=i24]
  %empty_87 = or i24 %empty_86, %empty_85         ; [#uses=1 type=i24]
  ret i24 %empty_87
}
...
entry:
  ...
  %empty_88 = zext i3 %1 to i16                   ; [#uses=1 type=i16]
  %empty_89 = shl i16 %empty, 3                   ; [#uses=1 type=i16]
  %empty_90 = or i16 %empty_89, %empty_88         ; [#uses=1 type=i16]
  ret i16 %empty_90
}
...
!30 = metadata !{i32 786473, metadata !"sha256_impl.c", metadata !"E:\5Cacc_2562", null} ; [ DW_TAG_file_type ]
...
!36 = metadata !{i32 786473, metadata !"./sha256_impl.h", metadata !"E:\5Cacc_2562", null} ; [ DW_TAG_file_type ]
...
!60 = metadata !{i32 86, i32 72, metadata !29, null}
...
!67 = metadata !{i32 86, i32 51, metadata !29, null}
...
!88 = metadata !{i32 30, i32 54, metadata !85, null}
...
!92 = metadata !{i32 32, i32 43, metadata !90, null}
...
!141 = metadata !{i32 101, i32 50, metadata !137, null}
...
!186 = metadata !{i32 786473, metadata !"sha256.c", metadata !"E:\5Cacc_2562", null} ; [ DW_TAG_file_type ]
...
!191 = metadata !{i32 786443, metadata !185, i32 11, i32 32, metadata !186, i32 0} ; [ DW_TAG_lexical_block ]
...
!282 = metadata !{i32 786443, metadata !191, i32 54, i32 2, metadata !186, i32 6} ; [ DW_TAG_lexical_block ]
!283 = metadata !{i32 54, i32 18, metadata !282, null}
!284 = metadata !{i32 56, i32 3, metadata !285, null}
!285 = metadata !{i32 786443, metadata !282, i32 54, i32 23, metadata !186, i32 7} ; [ DW_TAG_lexical_block ]
!286 = metadata !{i32 58, i32 1, metadata !191, null}
